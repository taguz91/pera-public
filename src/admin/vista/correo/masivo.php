    ...
    <form class="form-horizontal" action="#" method="post" id="form-correos">
        ...
        <div class="col">
          ...
          <div class="form-group">
            ...
            <div class="btn-group btn-block" role="group">
              <input class="btn btn-info border-right" type="button" value="Agregar todos" onclick="agregarCorreosPeriodo()">
              <input class="btn btn-info border-left" type="button" value="Agregar ciclo" onclick="agregarCorreos()">
            </div>
          </div>

          <div class="form-group">
            <label for="">Mensaje:</label>
            <textarea name="mensaje" class="form-control" rows="8" cols="5" placeholder="Escriba el correo que enviara." required></textarea>
          </div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          value="Enviar Correos"  onclick="enviarCorreos()">
        </div>
      </div>
...
<script type="text/javascript" src="<?php echo constant('URL'); ?>public/js/ajax/correosmasivosalumnos.js?v=4"></script>
